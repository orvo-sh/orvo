...
ORDER BY (organization_id, service_name, deployment_environment, timestamp, id)
...
ORDER BY (organization_id, service_name, deployment_environment, start_time, trace_id, span_id)
TTL expires_at DELETE
-- statement-breakpoint
...
ORDER BY (organization_id, service_name, metric_name, time, id)
TTL expires_at DELETE
