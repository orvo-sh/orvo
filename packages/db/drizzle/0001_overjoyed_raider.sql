...
--> statement-breakpoint
ALTER TABLE "mcp_oauth_grant" ADD CONSTRAINT "mcp_oauth_grant_client_id_oauth_client_client_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."oauth_client"("client_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_oauth_grant" ADD CONSTRAINT "mcp_oauth_grant_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_oauth_grant" ADD CONSTRAINT "mcp_oauth_grant_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "mcp_oauth_grant_client_id_idx" ON "mcp_oauth_grant" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "mcp_oauth_grant_user_id_idx" ON "mcp_oauth_grant" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "mcp_oauth_grant_organization_id_idx" ON "mcp_oauth_grant" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "mcp_oauth_grant_client_user_uidx" ON "mcp_oauth_grant" USING btree ("client_id","user_id");--> statement-breakpoint
