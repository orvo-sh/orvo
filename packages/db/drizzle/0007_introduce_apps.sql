DROP TABLE IF EXISTS "alert_rule_destination" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "alert_delivery_attempt" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "alert_event" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "alert_incident" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "alert_rule" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "alert_webhook_destination" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "dashboard_log_view" CASCADE;
--> statement-breakpoint
DROP TABLE IF EXISTS "ingestion_key" CASCADE;
--> statement-breakpoint
CREATE TABLE "app" (
...
--> statement-breakpoint
ALTER TABLE "app" ADD CONSTRAINT "app_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "app" ADD CONSTRAINT "app_updated_by_user_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
CREATE INDEX "app_organization_id_idx" ON "app" USING btree ("organization_id");
--> statement-breakpoint
CREATE INDEX "app_created_by_idx" ON "app" USING btree ("created_by");
--> statement-breakpoint
CREATE UNIQUE INDEX "app_org_name_uidx" ON "app" USING btree ("organization_id","name");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "ingestion_key" ADD CONSTRAINT "ingestion_key_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "ingestion_key_app_id_idx" ON "ingestion_key" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "ingestion_key_one_active_kind_per_app_uidx" ON "ingestion_key" USING btree ("app_id","kind") WHERE "revoked_at" IS NULL;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alert_webhook_destination" ADD CONSTRAINT "alert_webhook_destination_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "alert_webhook_destination_app_id_idx" ON "alert_webhook_destination" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alert_rule" ADD CONSTRAINT "alert_rule_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "alert_rule_app_id_idx" ON "alert_rule" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alert_incident" ADD CONSTRAINT "alert_incident_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "alert_incident_app_id_idx" ON "alert_incident" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alert_event" ADD CONSTRAINT "alert_event_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "alert_event_app_id_idx" ON "alert_event" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alert_delivery_attempt" ADD CONSTRAINT "alert_delivery_attempt_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "alert_delivery_attempt_app_id_idx" ON "alert_delivery_attempt" USING btree ("app_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "dashboard_log_view" ADD CONSTRAINT "dashboard_log_view_app_id_app_id_fk" FOREIGN KEY ("app_id") REFERENCES "public"."app"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "dashboard_log_view_app_id_slug_uidx" ON "dashboard_log_view" USING btree ("app_id","slug");
