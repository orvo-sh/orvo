...
--> statement-breakpoint
CREATE INDEX "dashboard_log_view_organization_id_idx" ON "dashboard_log_view" USING btree ("organization_id");
--> statement-breakpoint
CREATE INDEX "dashboard_log_view_created_by_idx" ON "dashboard_log_view" USING btree ("created_by");
--> statement-breakpoint
CREATE INDEX "dashboard_log_view_updated_by_idx" ON "dashboard_log_view" USING btree ("updated_by");
--> statement-breakpoint
CREATE UNIQUE INDEX "dashboard_log_view_organization_slug_uidx" ON "dashboard_log_view" USING btree ("organization_id","slug");
