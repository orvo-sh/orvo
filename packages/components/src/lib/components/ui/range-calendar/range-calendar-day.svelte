...
<RangeCalendarPrimitive.Day
  ...
  class={cn(
    ...
    // range Start
    'data-[range-start]:bg-primary data-[range-start]:text-primary-foreground data-[range-start]:hover:primary-foreground',
    // range End
    'data-[range-end]:bg-primary data-[range-end]:text-primary-foreground data-[range-end]:hover:primary-foreground',
    // Outside months
