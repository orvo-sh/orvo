  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        ghost:
          'hover:bg-muted border hover:border-muted hover:text-foreground dark:hover:bg-muted/50 aria-expanded:bg-muted aria-expanded:text-foreground disabled:opacity-50',
        destructive:
