...
<Popover.Root bind:open>
	...
	>
		...
		<span class="rounded-full bg-muted px-2 py-0.5 text-xs font-semibold leading-none text-foreground">
		...
		<div class="flex flex-col gap-1">
			{#each options as option}
				...
				>
					...
					<span class={cn('size-2.5 shrink-0 rounded-full', option.colorClass)}></span>
