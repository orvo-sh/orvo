...
const authorizationHeader = "'Authorization': 'Bearer YOUR_KEY'";
...
sdk.start();`,
  },
  {
    ...
    body: "Use the OTLP HTTP exporters to send traces, metrics, and logs to Orvo.",
...
# Metrics and logs follow the same pattern`,
  },
  {
    ...
    body: "In Go, create an OTLP HTTP exporter and attach it to a tracer provider.",
...
func main() {
  ...
  },
  {
    ...
    body: "Configure the OTLP HTTP exporter with your endpoint and ingestion key.",
...
SdkTracerProvider tracerProvider = SdkTracerProvider.builder()
  ...
  },
  {
    ...
    body: "Use the OTLP HTTP exporter in the OpenTelemetry SDK.",
...
let tracer_provider = TracerProvider::builder()
  ...
  },
  {
    ...
    icon: IconCode,
    install: "",
    body: "Any OpenTelemetry collector or OTLP-compatible client can send to Orvo using your endpoint and ingestion key.",
    snippet: `OTEL_EXPORTER_OTLP_ENDPOINT=${ingestEndpoint}
