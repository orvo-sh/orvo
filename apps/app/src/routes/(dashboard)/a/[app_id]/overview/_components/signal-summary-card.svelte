...
<script lang="ts">
 ...
 <a {href}>
    <Card.Root class={cn("hover:ring-foreground/20 relative", loading && "pointer-events-none")}>
      <div
      ...
      <Card.Content>
        <div class="flex items-center justify-between gap-3">
          <div class="flex gap-3">
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-md bg-border text-secondary-foreground"
            >
              <Icon class="size-4" />
            </div>
            <div class="flex flex-col justify-center gap-px">
              ...
              <div class="flex gap-1.5">
                ...
                <span class={cn("mb-2 flex items-center gap-px text-xs",trend === 0 ? "text-muted-foreground" : trend > 0 ? "text-green-600" : "text-red-600")}>
                  {#if trend > 0}
