<script lang="ts">
  ...
  import { IconArrowUpRight, IconGitMerge } from '@tabler/icons-svelte';

  const signals = [
    { label: 'Checkout error rate', value: '8.2%', detail: 'Threshold 5%' },
    { label: 'p95 latency', value: '842 ms', detail: 'Threshold 500 ms' }
  ];
</script>
