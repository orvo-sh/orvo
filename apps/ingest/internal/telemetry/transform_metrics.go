...
func (service *Service) transformMetrics(resourceMetrics []*metricspb.ResourceMetrics) []MetricPoint {
...
func (service *Service) transformSum(sum *metricspb.Sum, name string, unit string, description string, serviceName string, deploymentEnvironment string, resourceAttributes map[string]string, scopeName string, scopeVersion string) []MetricPoint {
	var points []MetricPoint
...
func (service *Service) transformGauge(gauge *metricspb.Gauge, name string, unit string, description string, serviceName string, deploymentEnvironment string, resourceAttributes map[string]string, scopeName string, scopeVersion string) []MetricPoint {
	var points []MetricPoint
...
func (service *Service) transformHistogram(histogram *metricspb.Histogram, name string, unit string, description string, serviceName string, deploymentEnvironment string, resourceAttributes map[string]string, scopeName string, scopeVersion string) []MetricPoint {
	var points []MetricPoint
...
func (service *Service) transformExponentialHistogram(histogram *metricspb.ExponentialHistogram, name string, unit string, description string, serviceName string, deploymentEnvironment string, resourceAttributes map[string]string, scopeName string, scopeVersion string) []MetricPoint {
	var points []MetricPoint
	temporality := mapAggregationTemporality(histogram.GetAggregationTemporality())
