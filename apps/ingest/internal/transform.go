...
func withSignalMeta(meta MessageMeta, signal string, organizationID string, apiKeyID string) MessageMeta {
	meta.Version = "v1"
	meta.Signal = signal
...
func (service *IngestService) transformLogs(resourceLogs []*logspb.ResourceLogs) []LogRecord {
...
func (service *IngestService) transformTraces(resourceSpans []*tracepb.ResourceSpans) []Span {
	var spans []Span
